...
// in order (encoder 1 first, encoder 2 second), so they land on unit 0 and 1.
...
esp_err_t encoder_init(void)
{
    ...
    ESP_LOGI(TAG, "encoders ready: enc1 GPIO%d/%d, enc2 GPIO%d/%d",
             ENC1_GPIO_A, ENC1_GPIO_B, ENC2_GPIO_A, ENC2_GPIO_B);
    return ESP_OK;
}
